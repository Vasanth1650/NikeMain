...
function AddSaleProduct() {
    ...
    const handleClick = (e)=>{
        ...
        image2checker,collection,buyingoption,quantity,status}
                            ...
                            <div class="row">
                                ...
                                <div className='buyingoption' style={{width:"45%"}} onChange={(e)=>setImage2checker(e.target.value)}>
                                    <BootStrap.Form.Group className="mb-3"  required>
                                        <BootStrap.Form.Select id='image2checker' name='image2checker'>
                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                <div className='buyingoption' style={{width:"45%"}} onChange={(e)=>setStatus(e.target.value)}>
                                    <BootStrap.Form.Group className="mb-3"  required>
                                        <BootStrap.Form.Select id='status' name='status'>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="group" onChange={(e)=>setQuantity(e.target.value)}>
                                        ...
                                        <BootStrap.Form.Group className="mb-3"  required>
                                            ...
                                            <BootStrap.Form.Select id='quantity' name='quantity' 
                                        >
                                                <option></option>
                                                <option>1</option>
                                                <option>2</option>
